...
void show_help() {
#ifdef SUNRAY_TUI_DEFAULT_CHECK_MODE
  std::cout << "Sunray Dependency Check TUI - 交互式依赖检查工具\n\n用法: "
               "sunray_check_tui [选项]\n\n选项:\n";
#else
...
void show_version() {
#ifdef SUNRAY_TUI_DEFAULT_CHECK_MODE
  std::cout << "Sunray Dependency Check TUI v1.0\n交互式依赖检查工具\n";
#else
...
int main(int argc, char *argv[]) {
#ifdef SUNRAY_TUI_DEFAULT_CHECK_MODE
  AppMode app_mode = AppMode::Check;
#else
  ...
  try {
    std::vector<std::string> possible_paths = {
        "tools/check_scripts/modules.yaml", // workspace root
        "../modules.yaml", "../../modules.yaml", "modules.yaml",
        "../../../modules.yaml", "../tools/check_scripts/modules.yaml",
        "../../tools/check_scripts/modules.yaml"};
