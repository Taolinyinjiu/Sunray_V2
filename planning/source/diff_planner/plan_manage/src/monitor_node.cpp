...
void monitorCallback(const ros::TimerEvent &e)
{
  ...
  void waypointCallback(const diff_planner_msgs::GoalSetPtr &msg)
  {
...
int main(int argc, char **argv)
{
    ...
    waypointPub_ = nh.advertise<diff_planner_msgs::GoalSet>("/goal_with_id", 10);
