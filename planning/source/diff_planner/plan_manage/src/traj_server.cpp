...
diff_planner_msgs::PositionCommand cmd;
...
void yawCallback(const diff_planner_msgs::PositionCommandPtr msg)
{
  receive_yaw_ = true;
...
void publish_cmd(Vector3d p, Vector3d v, Vector3d a, Vector3d j, double y, double yd)
{
  ...
  cmd.trajectory_flag = diff_planner_msgs::PositionCommand::TRAJECTORY_STATUS_READY;
...
int main(int argc, char **argv)
{
  ...
  pos_cmd_pub = nh.advertise<diff_planner_msgs::PositionCommand>("/position_cmd", 50);
