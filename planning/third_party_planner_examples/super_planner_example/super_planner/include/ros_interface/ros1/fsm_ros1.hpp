...
#include "planner_msgs/SuperPositionCommand.h"
#include "planner_msgs/SuperPolynomialTrajectory.h"
...
namespace fsm {
    class FsmRos1 : public Fsm {
        ...
        planner_msgs::SuperPositionCommand pid_cmd_;
        rog_map::ROGMapROS::Ptr map_ptr_;
        planner_msgs::SuperPositionCommand latest_cmd;
        nav_msgs::Path path;

        vector<planner_msgs::SuperPositionCommand> cmd_logs_;
        ...
        void publishPolyTraj() override {
            planner_msgs::SuperPolynomialTrajectory cmd_traj;
            getCommittedTrajectory(cmd_traj);
            mpc_cmd_pub_.publish(cmd_traj);
        }

        void getOneHeartBeatMsg(planner_msgs::SuperPolynomialTrajectory &heartbeat, bool &traj_finish) {
            heartbeat.type = planner_msgs::SuperPolynomialTrajectory::HEART_BEAT;
        ...
        void getCommittedTrajectory(planner_msgs::SuperPolynomialTrajectory &cmd_traj) {
            cmd_traj.header.stamp = ros::Time::now();
            cmd_traj.header.frame_id = "world";
            cmd_traj.type = planner_msgs::SuperPolynomialTrajectory::POSITION_TRAJ |
                            planner_msgs::SuperPolynomialTrajectory::HEART_BEAT;
            ...
            if (!yaw_traj.empty()) {
                cmd_traj.type = cmd_traj.type |
                                planner_msgs::SuperPolynomialTrajectory::YAW_TRAJ;
        ...
        void getOnePositionCommand(planner_msgs::SuperPositionCommand &pos_cmd, bool &traj_finish) {
    ...
    public:
        ...
        void init(const ros::NodeHandle &nh, const std::string &cfg_path) {
            ...
            cmd_pub = nh_.advertise<planner_msgs::SuperPositionCommand>(cfg_.cmd_topic, 10);
            mpc_cmd_pub_ = nh_.advertise<planner_msgs::SuperPolynomialTrajectory>(cfg_.mpc_cmd_topic, 10);
        ...
        void pubCmdTimerCallback(const ros::TimerEvent &event) {
            ...
            planner_msgs::SuperPolynomialTrajectory heartbeat;
