...
planner_msgs::FuelPositionCommand cmd;
...
int main(int argc, char** argv) {
  ...
  pos_cmd_pub = node.advertise<planner_msgs::FuelPositionCommand>("/position_cmd", 50);
  ...
  cmd.trajectory_flag = planner_msgs::FuelPositionCommand::TRAJECTORY_STATUS_READY;
  cmd.trajectory_id = traj_id_;
