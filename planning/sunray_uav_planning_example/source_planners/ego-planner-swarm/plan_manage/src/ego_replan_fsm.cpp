...
namespace ego_planner
{
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
   ...
   // 目标点类型：1，手动设定目标点；2，预设目标点
    ...
    planner_prefix_ = loadTopicPrefix(nh);
    ...
    {
      string sub_topic_name = makePrefixedTopic(
          planner_prefix_,
    ...
    string pub_topic_name = makePrefixedTopic(
        planner_prefix_,
    ...
    else if (target_type_ == TARGET_TYPE::PRESET_TARGET)
    {
      ...
      trigger_sub_ = nh.subscribe(makePrefixedTopic(planner_prefix_, "/traj_start_trigger"), 1, &EGOReplanFSM::triggerCallback, this);
