...
void positionCmdCallback(const ego_planner_msgs::PositionCommand::ConstPtr& msg) {
    ...
    if (msg->trajectory_flag == ego_planner_msgs::PositionCommand::TRAJECTORY_STATUS_EMPTY ||
        ...
        msg->trajectory_flag ==
            ego_planner_msgs::PositionCommand::TRAJECTORY_STATUS_ILLEGAL_START ||
        msg->trajectory_flag ==
            ego_planner_msgs::PositionCommand::TRAJECTORY_STATUS_ILLEGAL_FINAL ||
        msg->trajectory_flag == ego_planner_msgs::PositionCommand::TRAJECTORY_STATUS_IMPOSSIBLE) {
