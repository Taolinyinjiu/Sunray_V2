...
struct EKF2_HGT_REF {
  ...
  bool is_baro() const noexcept { return value == Baro; }
  bool is_gnss() const noexcept { return value == Gnss; }
  bool is_range() const noexcept { return value == Range; }
  bool is_vision() const noexcept { return value == Vision; }
};
...
struct EKF2_EV_CTRL {
  ...
  void decode(raw_type raw) noexcept { value = static_cast<uint32_t>(raw); }
  ...
  bool enable_velocity() const noexcept { return (value & Velocity) != 0u; }
  bool enable_yaw() const noexcept { return (value & Yaw) != 0u; }
};
...
struct EKF2_EV_DELAY {
  ...
  void decode(raw_type raw) noexcept { value = raw; }
};
...
struct EKF2_MAG_TYPE {
  ...
  bool is_auto() const noexcept { return value == Auto; }
  bool is_yaw() const noexcept { return value == Mag_Yaw; }
  bool is_none() const noexcept { return value == None; }
};
...
struct EKF2_MAG_CHECK {
  ...
  bool enable_strength() const noexcept { return (value & Strength) != 0u; }
  bool enable_inclination() const noexcept {
    return (value & Inclination) != 0u;
  }
  bool enable_wait2wmm() const noexcept { return (value & Wait2WMM) != 0u; }
};
...
struct EKF2_GPS_CTRL {
  ...
  bool enable_lon_lat() const noexcept { return (value & Lon_Lat) != 0u; }
  bool enable_altitude() const noexcept { return (value & Altitude) != 0u; }
  bool enable_velocity3d() const noexcept { return (value & Velocity3D) != 0u; }
...
struct EKF2_GPS_CHECK {
  ...
  bool enable_max_pdop() const noexcept { return (value & Max_PDOP) != 0u; }
